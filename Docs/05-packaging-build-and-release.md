...
Missing entries are listed and the process exits 1 with `Missing packaged resources. Run: npm run prepare-dist`. It does not verify `resources/firefly/php`, marker contents, or that the Python tree matches the target arch.
