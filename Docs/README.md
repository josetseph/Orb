...
| 11 | [Multimedia enrichment](11-multimedia-enrichment.md) | Attachment discovery, PDF/image/audio/video/document handlers, vision via the chat model's projector, Qwen3-ASR and Marlin usage, `orb:extract` enrichment block format, temp-file rules |
