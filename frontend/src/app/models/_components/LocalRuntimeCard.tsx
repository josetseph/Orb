...
const ROWS: Array<{ key: Key; title: string; description: string; kind: "int" | "int?" | "float" | "bool" | "backend" }> = [
  ...
  { key: "large_attachment_tokens", title: "Summarize documents over (tokens)", description: "Longer documents are summarized for the graph and kept searchable in full. Recordings always are.", kind: "int" },
